...
import Navbar from './components/navbar/navbar-fixed.tsx'
import NavbarCenter from './components/navbar/navbar-center.tsx'
import PodcastWidget from './components/audio-widget/audio-widget.tsx'
import ComponentSelector from './components/component-selector.tsx'
import Toolbar from './components/figma-toolbar/toolbar.tsx'
...
function App() {
    ...
    if (isMobile) {
        return (
            <div
                className={'flex min-h-screen w-full flex-col items-center justify-center bg-gradient-to-br from-slate-100 to-slate-200 px-4 py-8 text-center'}>
                <svg
    ...
    return (
        <main className={'relative min-h-screen w-full bg-black/0'}>
            ...
            >
                ...
                <ComponentSelector activeComponent={activeComponent} onChange={setActiveComponent}/>
            </motion.div>
        </main>
    )
}
