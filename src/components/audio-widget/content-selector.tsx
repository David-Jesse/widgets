...
export const ContentSelectors = ({
    ...
    return (
        ...
        >
            ...
            >
                <div
                    className={'mx-auto flex w-max items-center justify-center gap-6 text-[18px] font-medium tracking-[-0.5px]'}>
                    {tabOptions.map((tab) => (
                        <h3
                            key={tab}
                            ref={(el) => {
                            ...
                            className={`cursor-pointer whitespace-nowrap transition-colors duration-300 ${selectedTab === tab ? "text-white" : "hover:text-white/40"}`}
            ...
            <div
                className={'mt-6 flex w-max items-center gap-10 text-[16px] font-medium tracking-[-0.3px] text-[#515151]'}>
