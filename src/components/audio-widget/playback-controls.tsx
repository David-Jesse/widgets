...
export const PlaybackControls = ({
    ...
    return (
        ...
        >
            <div
                className='flex h-[35px] w-[35px] items-center justify-center rounded-full transition-colors duration-300 hover:bg-white/20'>
            ...
            <div className={'ml-[3px] w-[337px]'}>
                <motion.div
                    onAnimationComplete={() => {
                        console.log('Player animation complete');
                        setExpand("stretchY")
                    }}
                    initial={{
                        opacity: 0,
