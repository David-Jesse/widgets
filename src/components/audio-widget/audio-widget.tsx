...
import {ContentSelectors} from "./content-selector.tsx";
import {AudioToggleButton} from "./audio-toggle-button.tsx";

const tabOptions = [
    "Quantum Computing",
    "Quantum Physics",
    "Tell me about Jhene Aiko",
    "Quantum Mechanics",
    "Non locality"
]
...
const AudioWidget = () => {
    ...
    useEffect(() => {
        if (expand && selectedTab) {
            // Small delay to ensure the DOM is fully centered
    ...
    const handlePlayPause = (e: React.MouseEvent) => {
        ...
        // If animation has completed and you're processing play again, reset everything
    ...
    return (
        ...
        >
            ...
            <AnimatePresence>
                {expand && (
                    <ContentSelectors tabsContainerRef={tabsContainerRef} tabRefs={tabRefs} tabOptions={tabOptions}
                                      selectedTab={selectedTab} selectedSpeed={selectedSpeed}
                                      handleTabChange={handleTabChange} handleSpeedChange={handleSpeedChange}/>
                )}
            </AnimatePresence>
