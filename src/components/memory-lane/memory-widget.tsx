...
const MemoryWidget = () => {
    ...
    const {formattedBeforeText, formattedAfterText} = calculateMemoryStats(centeredMonthIndex, data);
    ...
    return (
        <div
            ...
            <div
                className={'absolute bottom-10 flex w-full items-center justify-between px-1.5 text-[7px] text-[#515151'}>
                <AnimatePresence mode={'wait'}>
                    <motion.h6
