...
const ResourceDropdown = memo(() => (
    <div className={'flex'}>
        ...
        <div className={'flex w-[260px] flex-col gap-4 px-4 pb-10 pt-4'}>
            <h4 className={'mb-2 pl-2 text-[10px] font-medium text-gray-500'}>INSIGHTS</h4>
            <div className={'min-h-[30px] w-full rounded-xl bg-[#f3f4f6]'}/>
            <div className={'min-h-[30px] w-full rounded-xl bg-[#f3f4f6]'}/>
        </div>
    </div>
...
const NavbarCenter = () => {
    ...
    return (
        <nav
            className={'absolute left-0 right-0 top-5 mx-auto flex h-min w-[90%] xl:w-[70%] items-center justify-between rounded-2xl border border-gray-200 bg-white shadow-lg px-6 py-4 backdrop-blur-2xl'}>
